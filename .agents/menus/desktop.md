...
| work item detail modal | `apps/desktop/src/renderer-react/features/kanban/` | `KanbanCardModal` is the work item detail sheet (naming predates the retired Kanban board). Reachable from the Workbench work item list. |

...
| package metadata | `apps/extension/package.json`, `apps/extension/manifest/base.{openvsx,marketplace}.json` | Dual marketplace manifests; `package.json` is generated by `apps/extension/scripts/merge-extension-manifest.mjs`, so regenerate instead of hand-editing menu blocks. |

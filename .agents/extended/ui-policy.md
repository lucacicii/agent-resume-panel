...
- The top-level product areas are Memory, Ask, Workbench, Notes, Kanban, Sessions, and Settings. Extend their existing tab, sheet, list, and toolbar patterns rather than creating a parallel navigation model.

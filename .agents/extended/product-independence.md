...
| Electron desktop | `@agent-resume/desktop` (`apps/desktop/`) | `apps/desktop/package.json` | `.dmg` → `thunder-luc/agent-resume-desktop-doc` GitHub Releases (until the main repo is public) |

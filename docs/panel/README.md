...
Extension version: **2.11.1** · [Changelog](../../apps/extension/CHANGELOG.md) · Desktop: see [releases](https://github.com/thunder-luc/agent-resume-panel/releases)
...
扩展版本：**2.11.1** · [更新日志](../../apps/extension/CHANGELOG.md) · 桌面端版本见 [Releases](https://github.com/thunder-luc/agent-resume-panel/releases)

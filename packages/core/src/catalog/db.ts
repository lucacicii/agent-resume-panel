...
import { DESKTOP_AGENT_TRACE_MIGRATION_SQL, DESKTOP_ONLY_SCHEMA_SQL, IM_SELECTION_ACTION_MODEL_MIGRATION_SQL, IM_TOOLS_MIGRATION_SQL, SYNC_STATE_DESKTOP_MIGRATION_SQL } from "./desktopSchema";

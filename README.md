...
| **Desktop app (macOS)** | [`apps/desktop/`](apps/desktop/) | [Download DMG](https://github.com/lucacicii/agent-resume-panel/releases/latest) | [docs/desktop](docs/desktop/README.md) |
...
Copyright (C) 2026 lucacicii. Licensed under the [GNU Affero General Public License v3.0](LICENSE) (`AGPL-3.0-only`).
...
| Product | Issues |
|---------|--------|
| VS Code extension | [Issues](https://github.com/lucacicii/agent-resume-panel/issues) |
| Desktop app | [Issues](https://github.com/lucacicii/agent-resume-panel/issues) |
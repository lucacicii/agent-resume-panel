...
Extension version: **2.6.7** · Desktop: see [releases](https://github.com/thunder-luc/agent-resume-desktop-doc/releases)
...
扩展版本：**2.6.7** · 桌面端版本见 [Releases](https://github.com/thunder-luc/agent-resume-desktop-doc/releases)

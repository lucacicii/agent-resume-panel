...
const flat = {
  ...
  "desktop.report.legendDailyStale": { en: "Update pending", "zh-cn": "更 待更新" },
  "desktop.report.legendDailyMissing": { en: "Not generated", "zh-cn": "未 待生成" },
  "desktop.report.legendNoSession": { en: "No activity", "zh-cn": "无 无活动" },

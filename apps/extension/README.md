...
Extension version: **2.10.0** · Desktop: see [releases](https://github.com/thunder-luc/agent-resume-desktop-doc/releases)
...
[Install extension](https://marketplace.visualstudio.com/items?itemName=thunder-luc.agent-resume-panel-v2) · [Download Desktop (macOS)](https://github.com/thunder-luc/agent-resume-desktop-doc/releases/latest) · [Desktop docs](../../docs/desktop/README.md)
...
扩展版本：**2.10.0** · 桌面端版本见 [Releases](https://github.com/thunder-luc/agent-resume-desktop-doc/releases)
...
[安装扩展](https://marketplace.visualstudio.com/items?itemName=thunder-luc.agent-resume-panel-v2) · [下载 Desktop（macOS）](https://github.com/thunder-luc/agent-resume-desktop-doc/releases/latest) · [Desktop 文档](../../docs/desktop/README.md)

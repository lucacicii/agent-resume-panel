...
Extension version: **2.11.2** · Desktop: see [releases](https://github.com/lucacicii/agent-resume-panel/releases)
...
扩展版本：**2.11.2** · 桌面端版本见 [Releases](https://github.com/lucacicii/agent-resume-panel/releases)

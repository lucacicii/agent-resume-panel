...
Extension version: **2.11.1** · Desktop: see [releases](https://github.com/lucacicii/agent-resume-panel/releases)
...
[Install extension](https://marketplace.visualstudio.com/items?itemName=lucacicii.agent-resume-panel-v2) · [Download Desktop (macOS)](https://github.com/lucacicii/agent-resume-panel/releases/latest) · [Desktop docs](../../docs/desktop/README.md)
...
扩展版本：**2.11.1** · 桌面端版本见 [Releases](https://github.com/lucacicii/agent-resume-panel/releases)
...
[安装扩展](https://marketplace.visualstudio.com/items?itemName=lucacicii.agent-resume-panel-v2) · [下载 Desktop（macOS）](https://github.com/lucacicii/agent-resume-panel/releases/latest) · [Desktop 文档](../../docs/desktop/README.md)
...
| 问题反馈 | [Issues](https://github.com/lucacicii/agent-resume-panel/issues) |

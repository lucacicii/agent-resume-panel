...
Extension version: **2.8.1** · Desktop: see [releases](https://github.com/thunder-luc/agent-resume-desktop-doc/releases)
...
扩展版本：**2.8.1** · 桌面端版本见 [Releases](https://github.com/thunder-luc/agent-resume-desktop-doc/releases)

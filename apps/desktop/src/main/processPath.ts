/**
 * Resolve CLI commands for GUI-launched Electron.
 *
 * Dock / Finder launches inherit a minimal PATH (often without Homebrew, fnm,
 * nvm, Volta). ACP agents default to `npx`, which then fails with spawn ENOENT.
 */
